    ...
    <div className="home-container">
        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            ...
            <div className="home-buttons">
              ...
              <Link to="/register" className="buttonFilled">
                Register
              </Link>
            </div>
          </div>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav22 bodySmall">Settings</span>
                <span className="home-nav32 bodySmall">Profile</span>
                <span className="home-nav42 bodySmall">Log Out</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Capture Your Thoughts and Memories</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Enhance your journaling experience with these tools and
                      functionalities
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Record your thoughts and experiences on a daily basis"
              ></FeatureCard>
              <FeatureCard
                heading="Trackers"
                subHeading="Monitor your habits and progress with customizable trackers"
              ></FeatureCard>
              <FeatureCard
                heading="To-Do List"
                subHeading="Stay organized and productive by creating and managing tasks"
              ></FeatureCard>
              <FeatureCard
                heading="Chat Bot"
                subHeading="Engage in conversations and receive prompts for journaling"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Upgrade to unlock more features and enhance your journelling
                  experience
                </span>
              </span>
            </span>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                ...
                <span className="bodySmall">
                  Start your journelling journey for free
                </span>
              </div>
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Unlimited journal entries</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Basic tracking features</span>
                </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container13">
                ...
                <span className="bodySmall">
                  Upgrade for more features and customization
                </span>
              </div>
              ...
              <div className="home-container15">
                ...
                <div className="home-container18">
                  ...
                  <span className="bodySmall">Advanced tracking tools</span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Unlock the full potential of journelling
                </span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container26">
                  ...
                  <span className="bodySmall">Premium tracking analytics</span>
                </div>
                ...
                <div className="home-container28">
                  ...
                  <span className="bodySmall">24/7 dedicated support</span>
                </div>
              </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">Journal Your Journey</h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Start documenting your daily experiences, thoughts, and
                  emotions with our easy-to-use journaling platform. Reflect on
                  your past, track your progress, and unleash your creativity.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
          ...
          <button className="buttonFilled">Start Journaling</button>
        </div>
      </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="To create a new journal entry, go to the calendar and select the date you want to write about. Click on that date to start writing your entry."
                question="How do I create a new journal entry?"
              ></Question1>
              <Question1
                answer="Yes, you can edit or delete a journal entry. Simply go to the calendar, click on the date of the entry you want to modify, and then select the edit or delete option."
                question="Can I edit or delete a journal entry?"
              ></Question1>
              <Question1
                answer="You can customize your journal entries by adding photos, changing fonts, and organizing your entries using different categories. Explore the settings to personalize your journal."
                question="How can I customize my journal entries?"
              ></Question1>
              <Question1
                answer="Trackers are tools that help you monitor and track specific aspects of your life, such as mood, habits, or goals. You can use trackers to gain insights into your daily routines and progress."
                question="What are trackers in the journaling website?"
              ></Question1>
              <Question1
                answer="Yes, we take data security seriously. Your journaling data is encrypted and stored securely to ensure the privacy and confidentiality of your entries. You can also adjust privacy settings in your profile for added security."
                question="Is my journaling data secure on this website?"
              ></Question1>
            </div>
          </div>
        </div>
